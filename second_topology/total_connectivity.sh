...
#S3
sudo ovs-ofctl add-flow s3 in_port=1,actions=output:2,3,4
sudo ovs-ofctl add-flow s3 in_port=2,actions=output:1,3,4
sudo ovs-ofctl add-flow s3 in_port=3,actions=output:1,2,4
sudo ovs-ofctl add-flow s3 in_port=4,actions=output:1,2,3
